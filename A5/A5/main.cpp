//
// CS-432 A5
// Adds lighting and material shading to our scene
//
...
int main(int argc, char **argv)
{
	...
	windowID = glutCreateWindow("CS-432 A5");
...
void init()
{
	...
	groundPlane->setMaterial(vec4(0, 1, 0, 1), vec4(0.1, 0.35, 0.1, 1), vec4(0.45, 0.55, 0.45, 1), 32);
