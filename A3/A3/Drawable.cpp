...
void Drawable::increaseRotation()
{
	// increment angle
	rotationAngle++;
	...
	// mat.h RotateY expects its argument in DEGREES
	mat4 rotation = RotateY((GLfloat)rotationAngle);
	setModelMatrix(translation * rotation);
}
